...
(
	...
	WHERE 
	T2."U_BGT_Contract" = (SELECT TO_NVARCHAR("DocNum") FROM "@BGT_OCTR" WHERE "DocEntry" = '{0}') AND
	IFNULL(T2."U_BGT_Quantity",0) > 0 AND
	T2."U_BGT_DocType" NOT IN ('13','14','19','20') AND
	T2."U_BGT_DocType" = '116'
) X0
GROUP BY X0."Articulo",	 "Nom. Articulo",X0."Numero Documento",X0."Numero Interno",X0."Fecha de Documento",X0."Fecha de Factura",X0."Type",X0."Tipo Objeto",X0."Numero Guia",X0."Hora"
ORDER BY 
