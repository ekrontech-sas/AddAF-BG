select "Numero Documento", "Articulo","Nom. Articulo","Numero Interno","Fecha de Documento","Fecha de Factura","Type","Tipo Objeto","Numero Guia",sum("Cantidad") as "Cantidad","Hora"
from (
SELECT 
...
WHERE T0."DocEntry" = '{0}' AND T2."U_BGT_DocType" NOT IN ('13','14','19','20') AND IFNULL(T2."U_BGT_Quantity",0) > 0 
...
WHERE T2."U_BGT_Contract" = (SELECT TO_NVARCHAR("DocNum") FROM "@BGT_OCTR" WHERE "DocEntry" = '{0}') AND
	IFNULL(T2."U_BGT_Quantity",0) > 0 AND T2."U_BGT_DocType" NOT IN ('13','14','19','20') AND T2."U_BGT_DocType" = '116'
)TR
group by "Numero Documento", "Articulo","Nom. Articulo","Numero Interno","Fecha de Documento","Fecha de Factura","Type","Tipo Objeto","Numero Guia","Hora"
ORDER BY 2 ASC, 6